...
<body>
  ...
  <div class="home" id="zones" hx-swap="outerHTML">
    ...
    <a hx-get="analyse.php" hx-push-url="true" hx-target="#zones" hx-select="#zones" hx-swap="outerHTML swap:0.5s" class="btnIndex2">Page analyse</a>
    ...
    <div class="sectionHome">
      ...
      <a hx-get="comparateur.php" hx-push-url="true" hx-target="#zones" hx-select="#zones" hx-swap="outerHTML swap:0.5s" class="btnIndex2">Accédez au comparateur</a>
      <div class="content" id="L">
