...
var_dump($plane);
echo "<br>getTravel<br>";
var_dump($plane->getTravel(getCoordinates($mode, $country_src, $city_src, $airport_src), getCoordinates($mode, $country_dst, $city_dst, $airport_dst)));

echo "<br>class Train<br>";
$train = new Train();
var_dump($train);
echo "<br>getTravel<br>";
var_dump($train->getTravel(getCoordinates($mode, $country_src, $city_src, $airport_src), getCoordinates($mode, $country_dst, $city_dst, $airport_dst)));
