...
1. **IDH et espérance de vie** : Nous avons observé une forte corrélation positive entre l’IDH et l’espérance de vie, confirmée par un score R² de 0.794. Cela suggère que l’IDH est un bon prédicteur de l’espérance de vie.(cf. figure 1.9)
...
### Introduction générale aux séries temporelles
...
### Paramétrage et évaluation du modèle ARIMA
...
### Recherche en grille des hyperparamètres ARIMA
...
![Représentation mondiale du Score Touristique](img-rapport-final/score.png){width=400px, height=280px }

![Distribution du Score Touristique](img-rapport-final/score-2.png){width=400px, height=280px }

\newpage

## Analyse en Composantes Principales (ACP)

![Cercle de corrélation](img-rapport-final/acp){width=500px, height=500px }

## Clustering

![Représentation des clusters et des centroïdes dans un espace tridimensionnel défini par le PIB par habitant, les émissions de CO2 par habitant et le GPI](img-rapport-final/clustering){width=500px, height=300px }

![Carte Géographique des 3 Clusters](img-rapport-final/carte-clustering){width=500px, height=300px }

## Clustering+
![Représentation des clusters et des centroïdes dans un espace tridimensionnel défini par le PIB par habitant, les émissions de CO2 par habitant et le GPI](img-rapport-final/clustering-8){width=500px, height=300px }

![Carte Géographique des 8 Clusters](img-rapport-final/carte-clustering-8){width=500px, height=300px }


## Régression linéaire 
![ Régression linéaire 1 ](img-rapport-final/regression-1){width=500px, height=300px }

![ Régression linéaire 2 ](img-rapport-final/regression-2){width=500px, height=300px }

## ARIMA
![Prédiction sur l'échantillion](img-rapport-final/arima-1){width=500px, height=300px }

![Prédiction sur l'échantillion pour l'année n-1](img-rapport-final/arima-2){width=500px, height=300px }

![Prédiction hors échantillion](img-rapport-final/arima-3){width=500px, height=300px }
